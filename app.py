...
def api_health():
    ...
    if (
        ...
        and (now - st.session_state.health_ts) < 10
    ):
...
with st.sidebar:
    ...
    st.info("Horizon Bank")

    st.caption("Conversational Assistant")
...
if not st.session_state.messages:
    ...
    st.info(
        ...
        "below or choosing a quick prompt."
    )
